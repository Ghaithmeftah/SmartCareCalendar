...
import '../components/booking_doctor_calendar_main.dart';
import '../model/booking_service.dart';
import '../model/enums.dart';
import 'booking_controller.dart';

class BookingDoctorCalendar extends StatelessWidget {
  const BookingDoctorCalendar(
      {Key? key,
  ...
  final Booking_Service bookingService;
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: BookingDoctorCalendarMain(
        key: key,
