            ...
            Ink(
              child: InkWell(
                onTap: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        DoctorFormularScreenFastAPI(freeDates),
                  ),
                ),
                child: const Padding(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 10.0),
                                child: Text(
                                  _timeToString(timeStringToTimeOfDay(calendar!
                                      .finPause)), //you need to change this accordingly to the database
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold),
                                ),
                              ),
                              Padding(
                                ...
                                child: Text(
                                    _timeToString(timeStringToTimeOfDay(calendar!
                                        .endTime)), //you need to change this accordingly to the database
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold)),
                              ),
                            ],
