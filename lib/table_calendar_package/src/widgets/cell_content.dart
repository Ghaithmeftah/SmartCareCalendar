...
class CellContent extends StatelessWidget {
  ...
  const CellContent({
    ...
    required this.isWholeDayBooked,
  ...
  Widget build(BuildContext context) {
    ...
    if (isDisabled) {
      ...
      //this is for the Doctor's busy days to be highlighted in orange
    } else if (isBusyDay) {
      cell = calendarBuilders.busyDayBuilder?.call(context, day, focusedDay) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
            decoration: calendarStyle.busyDayDecoration,
            alignment: alignment,
            child: Text(text, style: calendarStyle.busyDayTextStyle),
          );
      if (isSelected) {
        cell =
    ...
    } else if (isWholeDayBooked) {
      cell = calendarBuilders.wholeDayBookedBuilder
              ?.call(context, day, focusedDay) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
            decoration: calendarStyle.wholeDayBookedDecoration,
            alignment: alignment,
            child: Text(text, style: calendarStyle.wholeDayBookedTextStyle),
          );
      if (isSelected) {
        cell =
            calendarBuilders.selectedBuilder?.call(context, day, focusedDay) ??
