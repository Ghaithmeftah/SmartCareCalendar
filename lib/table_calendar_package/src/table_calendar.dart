...
class TableCalendar<T> extends StatefulWidget {
  ...
  final bool Function(DateTime day)? busydayPredicate;
  final bool Function(DateTime day)? wholeDayBookedPredicate;
  ...
  TableCalendar({
    ...
    this.busydayPredicate,
    this.wholeDayBookedPredicate,
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = CellContent(
          ...
          isBusyDay: widget.busydayPredicate?.call(day) ?? false,
          isWholeDayBooked: widget.wholeDayBookedPredicate?.call(day) ?? false,
          isWeekend: isWeekend,
