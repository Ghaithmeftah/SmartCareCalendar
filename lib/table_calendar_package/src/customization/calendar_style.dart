...
class CalendarStyle {
  ...
  final TextStyle wholeDayBookedTextStyle;
  ...
  final TextStyle busyDayTextStyle;
  ...
  final Decoration busyDayDecoration;
  final Decoration wholeDayBookedDecoration;
  ...
  const CalendarStyle({
    ...
    this.rangeHighlightColor = const Color(0xFFeef3d8),
    ...
    this.wholeDayBookedTextStyle = const TextStyle(
      color: AppColors.pink,
      fontSize: 16.0,
    ),
    this.selectedDecoration = const BoxDecoration(
      color: const Color(0xFFf0787a),
      shape: BoxShape.circle,
    ),
    ...
    //busy day textStyle color
    this.busyDayTextStyle = const TextStyle(
      color: AppColors.orangeaccent,
      fontSize: 16.0,
    ),
    this.disabledDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.busyDayDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.wholeDayBookedDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.holidayTextStyle = const TextStyle(color: const Color(0xFFeef3d8)),
    this.holidayDecoration = const BoxDecoration(
      border: const Border.fromBorderSide(
        const BorderSide(color: const Color(0xFFeef3d8), width: 1.4),
      ),
      shape: BoxShape.circle,
    ),
    this.weekendTextStyle = const TextStyle(
        color: const Color(0xFF5A5A5A)), //const Color(0xFF5A5A5A)
    this.weekendDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.weekNumberTextStyle = const TextStyle(
        fontSize: 12, color: const Color(0xFFBFBFBF)), //const Color(0xFFBFBFBF)
